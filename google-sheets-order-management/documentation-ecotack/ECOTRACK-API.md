...
Saved at: 2026-03-29T14:20:46.983Z

Collection published at: 2021-03-05T16:06:59.000Z
...
- Authorisation (1 endpoint)
- Taux limite (1 endpoint)
- Commandes (6 endpoints)
- Suivi des commandes (7 endpoints)
...
Endpoints in this section: 3

## GET Liste des wilayas actives

URL: `{{url}}/api/v1/get/wilayas`
...
#### Liste des wilayas actives (200 OK)
...
## GET Liste des communes actives

URL: `{{url}}/api/v1/get/communes?wilaya_id`
...
| Name | Example | Description |
| --- | --- | --- |
| wilaya_id | | Optionnel \| Entre 1 et 58 |

### Example Responses

#### Liste des communes actives (200 OK)
...
No response body example provided.

---

## GET Tarifs des prestations

URL: `{{url}}/api/v1/get/fees`
